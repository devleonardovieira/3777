...
enum StashCategory_t : uint8_t
{
	STASH_CATEGORY_SHOW_ALL = 0,
	STASH_CATEGORY_CREATURE_PRODUCTS = 1,
	STASH_CATEGORY_DECORATION = 2,
	STASH_CATEGORY_FOOD = 3,
	STASH_CATEGORY_OTHERS = 4,
	STASH_CATEGORY_POTIONS = 5,
	STASH_CATEGORY_RUNES = 6,
	STASH_CATEGORY_TOOLS = 7,
	STASH_CATEGORY_VALUABLES = 8,
	STASH_CATEGORY_WEAPONS_AMMO = 9,
