...
class Map
{
	public:
		...
		static const int32_t maxViewportX = 21; //min value: maxClientViewportX + 1
		static const int32_t maxViewportY = 21; //min value: maxClientViewportY + 1
		static const int32_t maxClientViewportX = 20;
